...
{
    public class CarProcessModel : ISimProcessModel
    {
        public IEnumerable<Step> GetSteps()
        {
            List<CarStep> returnList = new List<CarStep>();
            List<STEP> stepList = InputMart.Instance.GetList<STEP>(InputTable.STEP);
            foreach (STEP step in stepList)
            {
                CarStep ps = new CarStep();
        ...
        {
            List<CarProcess> returnList = new List<CarProcess>();
            ...
            foreach (PROCESS process in processes)
            {
                ...
                CarProcess proc = new CarProcess();
